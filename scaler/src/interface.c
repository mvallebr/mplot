...
create_wndMain (void)
{
  ...
  label5 = gtk_label_new (_("O arquivo de geometria é um arquivo texto exportado pelo ansys. Na versão 5.5 do ansys, basta ir ao menu pre-processor/archivemodel/write para abrir a janela de exportação. Deve-se selecionar apenas a geometria (GEOM) na lista que aparece nessa tela. Opcionalmente, pode-se usar o comando CDWRITE."));
  ...
  btnExtraNode = gtk_toggle_button_new_with_label (_("Nó extra?"));
  ...
  label15 = gtk_label_new (_("Opções"));
  ...
  btnDiam = gtk_toggle_button_new_with_label (_("Adjacente"));
...
create_wndError (void)
{
  ...
  lbError = gtk_label_new (_("Nome de arquivo inválido!"));
